...
- (VERY IMPORTANT) If the deviec freezes on audio playback, downgrade the TinyUSB version from `0.18.0` (which comes bundled with Pico SDK 2.3.0) to `0.17.0`. Debugging this took me hours and this was the only fix I found that worked for me.